...
class SupabaseSingleton:
    """
    A singleton class for the Supabase client.
    """
    _instance = None
    ...
    def __new__(cls):
        ...
        if cls._instance is None:
            ...
            if not url or not key:
                raise ValueError("環境變數中缺少 SUPABASE_PROJECT_URL 或 SUPABASE_SERVICE_ROLE_KEY")
...
supabase_admin = SupabaseSingleton().client
